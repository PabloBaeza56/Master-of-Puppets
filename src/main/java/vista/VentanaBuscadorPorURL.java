...
public class VentanaBuscadorPorURL extends javax.swing.JFrame {
    ...
    public VentanaBuscadorPorURL(ControladoresConcretos controlador) {
        initComponents();
        setResizable(false);
    ...
    private void botonEjecutarBusquedaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEjecutarBusquedaActionPerformed
        ...
        controlador.VentanaBuscadorPorURL(CadenaBusqueda, this);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            //new VentanaBuscadorPorURL(controlador).setVisible(true);
        });
    }
